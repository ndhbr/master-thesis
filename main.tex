...
\input{pages/theoretischer_hintergrund}
\newpage

% Methodik
\input{pages/methodik}
\newpage

% Konzept und Umsetzung an der OTH-Regensburg
\input{pages/konzept_und_umsetzung}
\newpage

% Mockup-, und Prototypen-Studie
\input{pages/user_centered_design}
\newpage

% Evaluierung und Validierung
% \input{pages/evaluierung_und_validierung}
% \newpage

% Finale Implementierung
\input{pages/implementierung_und_deployment}

% Diskussion und Ausblick
\input{pages/diskussion_und_ausblick}
\newpage
